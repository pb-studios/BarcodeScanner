...
protocol CameraViewControllerDelegate: class {
    ...
    // MARK: - @ftamur
    // custom button for ui image picker
...
public final class CameraViewController: UIViewController {
    ...
    // MARK: - @ftamur
    /// Button that opens ui image picker
    public private(set) lazy var pickerButton: UIButton = .init(type: .custom)
    ...
    private func setupActions() {
        ...
        pickerButton.addTarget(
            self,
            action: #selector(handlePickerButtonTap),
            for: .touchUpInside)
    ...
    // MARK: - @ftamur
    /// Opens image picker to chose image from gallery
    @objc private func handlePickerButtonTap() {
        delegate?.cameraViewControllerDidTapPickerButton(self)
    }
    ...
    func setupConstraints() {
        if #available(iOS 11.0, *) {
            NSLayoutConstraint.activate(
                // MARK: - @ftamur
                // constraints for picker button
                pickerButton.topAnchor.constraint(
                    equalTo: view.safeAreaLayoutGuide.topAnchor,
                    constant: 30
                ),
                pickerButton.leadingAnchor.constraint(
            ...
            NSLayoutConstraint.activate(
                // MARK: - @ftamur
                // constraints for picker button
                pickerButton.topAnchor.constraint(equalTo: view.topAnchor, constant: 30),
                pickerButton.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 13),
